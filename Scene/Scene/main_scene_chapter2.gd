...
func add_dialog_after_grok():
	dialog_all_pool += [
		...
		"Att fråga AI är ett ganska direkt sätt att faktagranska, men det betyder inte att svaret alltid är helt korrekt.",
		"Varför säger du så?",
		"AI kan inte ersätta vårt eget tänkande. Här finns till exempel en kommentar från en läsare.",
		"Åh! Den säger att de två unga männen i bilden faktiskt hjälper offret att resa sig.",
		"Precis. Ibland kan information och bakgrund motsäga varandra, så vi måste själva leta vidare.",
		"Jag har samlat lite information – både från mer pålitliga medier och från sociala medier.",
		"Kanske kan vi pussla ihop vad som egentligen hände.",
		"Ja, låt oss prova tillsammans."
		]
...
var show_reader_context: int = 13
func check_dialog_event(dia_num: int):
	match dia_num:
		...
		show_reader_context:
			Global.emit_signal("case2_reader_context")
