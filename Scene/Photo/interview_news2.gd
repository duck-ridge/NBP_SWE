...
var content1_pro = "The local medics saved the our warriors, showing who their true friends were and proving the our commitment to unity and strength."
var content1_con = "The enemy guerrilla ambushed and captured our soldier, showcasing their strength and resolve for freedom."

var content2_con = "The prisoner, though unwilling, was powerless; his limbs were tightly bound, mirroring his nation’s entanglement in the quagmire of war."
var content2_pro = "Enduring the pain of their wounds, the local medics held the injured warriors’ hands tightly—blood and iron forged a friendship that could withstand any trial."

#
var content1_tendency: bool
var content2_tendency: bool
#新闻内容池
...
func load_options(option_code: int):
	...
	match option_code:
		1:
			...
			Button1.text = "他们是游击队"
			Button2.text = "他们是医务人员"
			$Secrtery/DescribeLeft/DialogBubble/Content.text = "They are medic from our side"
			$Secrtery/DescribeRight/DialogBubble/Content.text = "They are guerrilla from the enemy"
		2:
			edit_part = edit_part_pool[2]
			Button1.text = "这是解放者"
			Button2.text = "这是入侵者"
			$Secrtery/DescribeLeft/DialogBubble/Content.text = "He is a invader"
			$Secrtery/DescribeRight/DialogBubble/Content.text = "He is a liberator"
